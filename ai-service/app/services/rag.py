...
from app.services.gemini_service import embed_text, iter_answer_chunks
...
async def run_rag_stream(
    ...
    hits = await asyncio.to_thread(search, qvec, user_id=user_id, top_k=max(1, min(int(top_k or 0), 5)), file_id=file_id)
